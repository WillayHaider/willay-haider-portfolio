        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="mt-8 rounded-2xl border border-border bg-card/60 p-5 text-center shadow-xs">
            ...
            <div className="mt-4 flex items-center justify-center gap-2.5">
              ...
              {/* Snapchat */}
              <a
                href="https://snapchat.com/t/RSBQIyS6"
                target="_blank"
                rel="noopener noreferrer"
                aria-label="Snapchat Profile"
                className="btn-click-effect flex h-8 w-8 sm:h-9 sm:w-9 items-center justify-center rounded-lg bg-[#FFFC00] text-black shadow-2xs opacity-90 transition-all hover:opacity-100 hover:scale-105 active:scale-95"
              >
                <svg className="h-5 w-5 sm:h-5.5 sm:w-5.5 fill-current text-black" viewBox="3.2 1.5 17.6 17.6">
                  <path d="M12.016 2.002c-3.633 0-5.836 2.585-5.836 5.371 0 .963.266 2.379.791 3.424.168.334.12.551-.108.707-.37.253-.949.52-1.684.773-.418.143-.655.452-.614.778.053.42.49.658 1.053.738.835.12 1.636.036 2.215.75.545.67.65 1.768 1.34 2.328.618.502 1.385.502 2.053.502.26 0 .524-.015.79-.044.266.029.53.044.79.044.668 0 1.435 0 2.053-.502.69-.56.795-1.658 1.34-2.328.579-.714 1.38-.63 2.215-.75.563-.08 1-.318 1.053-.738.041-.326-.196-.635-.614-.778-.735-.253-1.314-.52-1.684-.773-.228-.156-.276-.373-.108-.707.525-1.045.791-2.461.791-3.424 0-2.786-2.203-5.371-5.836-5.371z" />
                </svg>
              </a>
              ...
              <a
                ...
                className="btn-click-effect flex h-8 w-8 sm:h-9 sm:w-9 items-center justify-center rounded-lg bg-[#FF4500] text-white shadow-2xs opacity-90 transition-all hover:opacity-100 hover:scale-105 active:scale-95"
              >
                <svg className="h-4 w-4 fill-current" viewBox="0 0 24 24">
