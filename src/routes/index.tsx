        ...
        <div className="flex flex-col items-center justify-between gap-6 md:flex-row">
          ...
          <div className="flex items-center gap-3">
            ...
            <a
              ...
              className="btn-click-effect h-8 w-8 sm:h-9 sm:w-9 rounded-lg bg-[#0A66C2] text-white flex items-center justify-center shadow-xs hover:opacity-90 hover:scale-105 active:scale-95 transition-all"
            >
              <svg className="h-4 w-4 sm:h-[18px] sm:w-[18px] fill-current" viewBox="0 0 24 24">
            ...
            <a
              ...
              className="btn-click-effect h-8 w-8 sm:h-9 sm:w-9 rounded-lg text-white flex items-center justify-center shadow-xs hover:opacity-90 hover:scale-105 active:scale-95 transition-all"
              style={{
                background: "radial-gradient(circle at 30% 107%, #fdf497 0%, #fdf497 5%, #fd5949 45%, #d6249f 60%, #285AEB 90%)",
              }}
            >
              <svg className="h-4 w-4 sm:h-[18px] sm:w-[18px] fill-current" viewBox="-1.5 -1.5 27 27">
            ...
            <a
              ...
              className="btn-click-effect h-8 w-8 sm:h-9 sm:w-9 rounded-lg bg-[#25D366] text-white flex items-center justify-center shadow-xs hover:opacity-90 hover:scale-105 active:scale-95 transition-all"
            >
              <svg className="h-4 w-4 sm:h-[18px] sm:w-[18px] fill-current" viewBox="0 0 24 24">
            ...
            <a
              ...
              className="btn-click-effect h-8 w-8 sm:h-9 sm:w-9 rounded-lg bg-[#EA4335] text-white flex items-center justify-center shadow-xs hover:opacity-90 hover:scale-105 active:scale-95 transition-all"
            >
              <svg className="h-4 w-4 sm:h-[18px] sm:w-[18px] fill-current" viewBox="0 0 24 24">
