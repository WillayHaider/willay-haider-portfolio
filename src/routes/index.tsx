        ...
        <div className="flex flex-col items-center justify-between gap-6 md:flex-row">
          ...
          <div className="flex items-center gap-2.5">
            ...
            <a
              ...
              className="btn-click-effect flex h-8 w-8 sm:h-8.5 sm:w-8.5 items-center justify-center rounded-lg border border-border bg-card/60 text-[#0A66C2] shadow-2xs transition-all hover:border-[#0A66C2]/40 hover:bg-[#0A66C2]/10 hover:scale-105 active:scale-95"
            >
            ...
            <a
              ...
              className="btn-click-effect flex h-8 w-8 sm:h-8.5 sm:w-8.5 items-center justify-center rounded-lg border border-border bg-card/60 text-[#E1306C] shadow-2xs transition-all hover:border-[#E1306C]/40 hover:bg-[#E1306C]/10 hover:scale-105 active:scale-95"
            >
            ...
            <a
              ...
              className="btn-click-effect flex h-8 w-8 sm:h-8.5 sm:w-8.5 items-center justify-center rounded-lg border border-border bg-card/60 text-[#25D366] shadow-2xs transition-all hover:border-[#25D366]/40 hover:bg-[#25D366]/10 hover:scale-105 active:scale-95"
            >
              <svg className="h-4 w-4 fill-current" viewBox="0 0 24 24">
            ...
            <a
              ...
              className="btn-click-effect flex h-8 w-8 sm:h-8.5 sm:w-8.5 items-center justify-center rounded-lg border border-border bg-card/60 text-[#EA4335] shadow-2xs transition-all hover:border-[#EA4335]/40 hover:bg-[#EA4335]/10 hover:scale-105 active:scale-95"
            >
              <svg className="h-4 w-4 fill-current" viewBox="0 0 24 24">
