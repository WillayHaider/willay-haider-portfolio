...
export function Nav() {
  ...
  return (
<header className="fixed top-0 z-50 w-full border-b border-border/35 bg-background/40 backdrop-blur-xl transition-all duration-300">      <div className="mx-auto flex max-w-7xl items-center justify-between px-6 py-4">
 <button
    ...
    <footer className="border-t border-border/40 py-8">
      <div className="mx-auto flex max-w-7xl flex-col items-center px-6 text-center text-sm text-muted-foreground gap-3">
        <div className="flex flex-wrap justify-center gap-4 text-sm">
          ...
          <Link to="/privacy-policy" className="hover:text-primary transition-colors">Policies</Link>
