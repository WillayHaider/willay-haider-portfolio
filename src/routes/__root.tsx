          ...
          "@graph": [
            ...
            },
            {
              ...
              sameAs: [
                ...
                "https://snapchat.com/t/RSBQIyS6",
                "https://www.reddit.com/u/Willayhaider/s/DQkspODBGo",
              ],
              email: "contact.whaider@gmail.com",
              telephone: "+923206990099",
              description:
                "Professional BDR and Outbound Sales Leader with 57,000+ dialed calls and $2.6M+ in verified closed revenue across SaaS, healthcare, and enterprise B2B verticals.",
              knowsAbout: [
                "B2B Cold Calling",
                "Appointment Setting",
                "B2B Lead Generation",
...
function RootShell({ children }: { children: ReactNode }) {
  return (
    <html lang="en">
      <head>
        {/* Google tag (gtag.js) */}
        <script async src="https://www.googletagmanager.com/gtag/js?id=G-CVRVVVK5HE" />
        <script
