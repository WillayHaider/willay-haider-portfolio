              ...
              <ul className="list-disc pl-6 sm:pl-8 space-y-2">
                <li>
                  ...
                  <ul className="list-circle pl-6 sm:pl-8 mt-1.5 space-y-1 text-xs sm:text-sm text-muted-foreground">
                    ...
                    <li>Vizocom ICT LLC ($900K+ Generated in Healthcare & Industrial)</li>
                    <li>OMC Group LLC ($350K+ Generated, 75% Connect Rate in Legal SEO Outbound)</li>
                    <li>Autolift Transport / Nexus LTD ($170K+ Generated, 1,100+ Freight Loads Dispatched)</li>
                  </ul>
                </li>
                <li>
