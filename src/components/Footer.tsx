      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6">
        ...
        <div className="flex flex-col items-center justify-between gap-6 md:flex-row">
          ...
          <div className="flex flex-wrap items-center justify-center gap-4 text-xs font-semibold text-muted-foreground sm:gap-6">
            ...
            <a href="/hire-in-house" className="transition-colors hover:text-primary">Hire In-House</a>
          ...
          <div className="flex items-center gap-2">
            ...
            <a
              ...
              className="btn-click-effect flex h-7.5 w-7.5 sm:h-8 sm:w-8 items-center justify-center rounded-lg bg-[#FFFC00] text-black shadow-2xs opacity-90 transition-all hover:opacity-100 hover:scale-105 active:scale-95"
            >
              <svg className="h-4.5 w-4.5 sm:h-5 sm:w-5 fill-current text-black" viewBox="3.2 1.5 17.6 17.6">
        ...
        <div className="mt-8 flex flex-col items-center justify-between gap-3 border-t border-border/60 pt-4 text-[11px] font-medium text-muted-foreground sm:flex-row">
          ...
          <div className="flex flex-wrap items-center justify-center gap-4">
            ...
            <a href="/sitemap.xml" className="hover:text-primary transition-colors font-medium">
              XML Sitemap
            </a>
          </div>
        </div>
