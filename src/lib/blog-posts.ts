...
export const BLOG_POSTS: BlogPost[] = [
  {
    ...
    metaDescription: "Master the 'send me an email' cold calling objection with 3 battle-tested live scripts, the LAER framework, real conversion stats, and prevention tactics.",
